...
<script>
    ...
    async function getList() {
        ...
        document.getElementById('total').innerText = formatRupiah(res.data['total']);
        document.getElementById('vat').innerText = formatRupiah(res.data['vat']);
        document.getElementById('payable').innerText = formatRupiah(res.data['payable']);
