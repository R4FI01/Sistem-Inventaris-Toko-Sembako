    ...
    <script>
        ...
        function add() {
           ...
           if(PId.length===0){
               ...
               errorToast("Jumlah beli wajib diisi");
           }
           else{
        ...
        async function CustomerList(){
            ...
            res.data.forEach(function (item,index) {
                let row=`<tr class="text-xs">
                        ...
                        <td><a data-name="${item['name']}" data-email="${item['email']}" data-id="${item['id']}" class="btn btn-outline-dark addCustomer  text-xxs px-2 py-1  btn-sm m-0">Pilih</a></td>
                     </tr>`
